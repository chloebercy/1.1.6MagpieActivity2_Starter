    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "any japanese") >= 0) 
        {
            ...
            if (findKeyword(statement, "somerset" >= 0)){
                ...
                response = "a j";
            } else if (findKeyword(statment, "sentosa" >= 0)){
                response = "a j";
            } else if (findKeyword(statment, "esplanade" >= 0)){
                response = "a j";
            } else {
                response = "a j";
            } 
        ...
        else if (findKeyword(statement, "korean bbq") >= 0) 
        {
            ...
            if (findKeyword(statment, "somerset" >= 0)){
                response = "k b";
            } else if (findKeyword(statment, "marina bay" >= 0)){
                response = "k b";
            } else if (findKeyword(statment, "sentosa" >= 0)){
                response = "k b";
            } else if (findKeyword(statment, "esplanade" >= 0)){
